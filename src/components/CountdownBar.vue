<template>
  <div 
    class="fixed bottom-0 left-0 right-0 bg-blue-800 text-white py-4 px-5 shadow-2xl z-50 border-t-4 border-accent transition-transform duration-500 ease-out"
