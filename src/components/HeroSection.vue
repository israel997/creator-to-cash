<template>
  <section class="bg-gradient-to-br from-[#0c1844] to-blue-800 text-white py-16 px-5 text-center relative overflow-hidden">
    ...
    <div class="max-w-3xl mx-auto relative z-10">
      ...
      <h1 class="text-5xl md:text-6xl lg:text-6xl font-black leading-tight mb-4">
        CREATOR TO CASH
      </h1>
      
      <p class="text-lg md:text-xl leading-relaxed mb-6 opacity-95">
        Business Suit 3.0 + Accompagnement pro
      </p>

      <h2 class="text-3xl md:text-4xl font-bold mb-7">
        Bienvenue <span v-if="userName" class="text-blue-400">{{ userName }}</span> !
      </h2>
      ...
      <div class="bg-white/15 backdrop-blur-lg rounded-2xl p-8 mb-8">
        ...
        <div class="text-base font-semibold uppercase tracking-wider mb-2">On démarre dans</div>
